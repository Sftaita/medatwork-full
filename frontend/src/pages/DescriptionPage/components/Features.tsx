    ...
    <Box>
      <Box marginBottom={4}>
        ...
        <Typography variant="h6" align={"center"} color={"text.secondary"} data-aos={"fade-up"}>
          Enregistrez-vous, créez vos années à gérer et invitez
          <br />
          vos MACCS et collaborateurs.
        </Typography>
              ...
              <Grid container spacing={4}>
                <Grid item xs={12}>
                  <Box display={"flex"} flexDirection={"column"} alignItems={"center"}>
                    <Typography variant={"h1"} sx={{ fontWeight: 700 }} color={"primary"}>
                      15%
                    </Typography>
                    <Typography color={"text.secondary"}>per successful transaction</Typography>
                  </Box>
                </Grid>
                <Grid item xs={6}>
                  <Box display={"flex"} flexDirection={"column"} alignItems={"center"}>
        ...
        <Grid item container xs={12} md={6} alignItems={"center"}>
          <Box component={Card} bgcolor={theme.palette.primary.main}>
            ...
            >
              ...
              <Typography gutterBottom align={"center"} sx={{ color: theme.palette.common.white }}>
                Design a custom package for your business.
              </Typography>
              <Typography align={"center"} sx={{ color: theme.palette.common.white }}>
                Available for businesses with large payments volume or unique business models.
              </Typography>
            </CardContent>
            <Divider />
            <CardActions sx={{ justifyContent: "center" }}>
              <Box component={Button} color={theme.palette.common.white} size={"large"}>
                Contact sales
              </Box>
            </CardActions>
          </Box>
